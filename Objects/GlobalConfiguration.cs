        ...
        private void instantiateEnemyConfigs(GlobalInformation globalInfo, ConfigFile fileConfigFile)
        {
            // Process enemies
            {
                ...
                foreach (EnemyType enemyType in globalInfo.allEnemyTypes)
                {
                    ...
                    typeConfiguration.spawnGroupCount = BindEmptyOrDefaultable(enemyConfig, tablename, "SpawnInGroupsOf", enemyType.spawnInGroupsOf, $"How many {enemyType.enemyName}s this tries to spawn at once\nAlternate values: DEFAULT");
